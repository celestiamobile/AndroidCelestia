...
@HiltViewModel
class AddonManagerViewModel @Inject constructor(val appCore: AppCore, val executor: Executor, val resourceManager: ResourceManager, val addonUpdateManager: AddonUpdateManager, val resourceAPI: ResourceAPIService, val purchaseManager: PurchaseManager): ViewModel() {
