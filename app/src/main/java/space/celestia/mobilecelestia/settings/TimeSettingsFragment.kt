...
import space.celestia.mobilecelestia.settings.viewmodel.TimeSettingsPage
import space.celestia.mobilecelestia.settings.viewmodel.TimeSettingsViewModel
import space.celestia.mobilecelestia.utils.CelestiaString

@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun TimeSettingsContainer() {
    val viewModel: TimeSettingsViewModel = hiltViewModel()
