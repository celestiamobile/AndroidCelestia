...
class NewHelpFragment: Fragment() {
    ...
    private fun MainScreen() {
        ...
        val webViewState = rememberWebViewState(url = URLHelper.buildInAppGuideShortURI("/help/welcome", language, false).toString(), matchingQueryKeys = listOf("guide"), filterURL = true)
