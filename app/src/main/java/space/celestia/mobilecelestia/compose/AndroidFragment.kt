...
// Copied from package androidx.fragment.compose, but fixing https://issuetracker.google.com/issues/463591210
...
fun <T : Fragment> AndroidFragment(
    ...
    val containerFactory = remember { FragmentContainerViewFactory(View.generateViewId()) }
    ...
    DisposableEffect(fragmentManager, containerFactory, clazz, fragmentState) {
        ...
        val fragment =
            fragmentManager.findFragmentByTag("${containerFactory.containerId}")
                    ...
                    .apply {
                        ...
                        val transaction =
                            fragmentManager
                                ...
                                .add(containerFactory.container, this, "${containerFactory.containerId}")
...
private class FragmentContainerViewFactory(val containerId: Int) : (Context) -> View {
