...
@Composable
internal fun DateInputDialog(onDismissRequest: () -> Unit, confirmHandler: () -> Unit, title: String, text: String?, formatter: SimpleDateFormat, dateChange: (Date?, String) -> Unit) {
    TextInputDialog(
...
@Composable
fun DateInputDialog(onDismissRequest: () -> Unit, errorHandler: () -> Unit, successHandler: (Date) -> Unit) {
