...
fun TextInputDialog(onDismissRequest: () -> Unit, confirmHandler: () -> Unit, title: String, text: String?, placeholder: String? = null, textChange: (String) -> Unit) {
    ...
    AlertDialog(onDismissRequest = onDismissRequest, confirmButton = {
        ...
        TextField(value = text ?: "", placeholder = if (placeholder != null) { { Text(text = placeholder) } } else null, onValueChange = textChange, modifier = Modifier.focusRequester(focusRequester))
    })
