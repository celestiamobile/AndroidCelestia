...
class EventFinderEclipseItem(val eclipse: CelestiaEclipseFinder.Eclipse): RecyclerViewItem

class EventFinderResultRecyclerViewAdapter(
    private val onEclipseChosen: (CelestiaEclipseFinder.Eclipse) -> Unit,
    eclipses: List<CelestiaEclipseFinder.Eclipse>
