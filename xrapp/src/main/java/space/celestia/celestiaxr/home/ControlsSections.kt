...
private val timeActions: List<Action> = listOf(
...
private val speedActions: List<Action> = listOf(
...
@Composable
private fun ActionButton(action: Action, viewModel: MainViewModel) {
